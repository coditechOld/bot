!function (e, t, n) {
    ...
    v = b = function () {
        ...
        for (var B = x(), E = function (t) {
            var n = t || e.event, o = n.target || n.srcElement, r = -1 !== o.className.indexOf("confirm"),
                s = C(B, "visible"), i = g.doneFunction && "true" === B.getAttribute("data-has-done-function");
            switch (n.type) {
                case"mouseover":
        ...
        m = t.onclick, t.onclick = function (t) {
            var n = t || e.event, o = n.target || n.srcElement, a = B === o, r = M(B, o), s = C(B, "visible"),
                i = "true" === B.getAttribute("data-allow-ouside-click");
            !a && !r && s && i && v.close()
        };
        var I = B.querySelector("button.confirm"), O = B.querySelector("button.cancel"),
